"""
Django settings for aurorian_searcher_api project.
...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost', '54.180.126.198']
...
WSGI_APPLICATION = 'aurorian_searcher_api.wsgi.application'
