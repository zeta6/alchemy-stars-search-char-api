...
class ActiveSkill(models.Model):
    ...
    asc0_brth_skill_1_cooltime = models.CharField(max_length=6, blank=True)
    asc0_brth_skill_1_preemptive = models.CharField(max_length=4, blank=True)
    asc0_brth_skill_1_text = models.TextField(blank=True)
    asc0_brth_skill_2_cooltime = models.CharField(max_length=6, blank=True)
    asc0_brth_skill_2_preemptive = models.CharField(max_length=4, blank=True)
    asc0_brth_skill_2_text = models.TextField(blank=True)
    asc2_brth_skill_0_cooltime = models.CharField(max_length=6, blank=True)
    asc2_brth_skill_0_preemptive = models.CharField(max_length=4, blank=True)
    asc2_brth_skill_0_text = models.TextField(blank=True)
    asc2_brth_skill_1_cooltime = models.CharField(max_length=6, blank=True)
    asc2_brth_skill_1_preemptive = models.CharField(max_length=4, blank=True)
    asc2_brth_skill_1_text = models.TextField(blank=True)
    asc2_brth_skill_2_cooltime = models.CharField(max_length=6, blank=True)
    asc2_brth_skill_2_preemptive = models.CharField(max_length=4, blank=True)
    asc2_brth_skill_2_text = models.TextField(blank=True)
    asc3_brth_skill_0_cooltime = models.CharField(max_length=6, blank=True)
    asc3_brth_skill_0_preemptive = models.CharField(max_length=4, blank=True)
    asc3_brth_skill_0_text = models.TextField(blank=True)
    asc3_brth_skill_1_cooltime = models.CharField(max_length=6, blank=True)
    asc3_brth_skill_1_preemptive = models.CharField(max_length=4, blank=True)
    asc3_brth_skill_1_text = models.TextField(blank=True)
    asc3_brth_skill_2_cooltime = models.CharField(max_length=6, blank=True)
    asc3_brth_skill_2_preemptive = models.CharField(max_length=4, blank=True)
