...
class Equipment(models.Model):
    ...
    image = models.ImageField(upload_to=upload_path, height_field=None, width_field=None, max_length=None, blank=True)
    ...
    def save(self, *args, **kwargs):
        if self.equip_id.rarity >= 5:
            ...
            if self.lv1_state_text == "":
                self.lv1_state_text = "공격력+25, 방어력+10, HP+50, 유리한 속성 데미지 3%"
            if self.lv2_state_text == "":
                self.lv2_state_text = "공격력+50, 방어력+20, HP+100, 유리한 속성 데미지 7%"
            if self.lv4_state_text == "":
                self.lv4_state_text = "공격력+75, 방어력+30, HP+200, 유리한 속성 데미지 11%"
            if self.lv5_state_text == "":
                self.lv5_state_text = "공격력+100, 방어력+40, HP+300, 유리한 속성 데미지 15%"
            if self.lv7_state_text == "":
                self.lv7_state_text = "공격력+140, 방어력+50, HP+400, 유리한 속성 데미지 20%"
            if self.lv8_state_text == "":
                self.lv8_state_text = "공격력+180, 방어력+60, HP+500, 유리한 속성 데미지 25%"
            if self.lv9_state_text == "":
                self.lv9_state_text = "공격력+220, 방어력+70, HP+600, 유리한 속성 데미지 30%"
